...
@ComponentScan(
		basePackageClasses = {
			   		utm.web.ComponentPackageMaker.class,
			   		utm.repository.ComponentPackageMaker.class,
			   		utm.service.ComponentPackageMaker.class,
			   		utm.component.ComponentPackageMaker.class}, 
